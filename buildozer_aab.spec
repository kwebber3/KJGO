...
requirements = python3,kivy,pandas,plyer,gtts,jisho_api,pydub,requests,urllib3,charset_normalizer,chardet,idna,pydantic==1.8.2 --only-binary=:all:,rich,markdown-it-py,mdurl,pygments,click,beautifulsoup4
