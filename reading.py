...
DICTIONARY_NAME = "Reading_Writing.txt"
...
class Reading(Toplevel,):
    def __init__(self):
        ...
        self.show_button = tkinter.Button(self, text="Show Reading", command=lambda:self.ShowReading())
    ...
    def GetCard(self):
      ...
      #  print(self.current_card)
        ...
        tkinter.Label(self.card_panel, text=Kanji, font="Helvetica 36").grid(row=0,column=0)
        self.reading = tkinter.Label(self.card_panel, text=Reading, font="Helvetica 36")
        self.reading.grid(row=1,column=0)
